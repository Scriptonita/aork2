  ...
  switch ($idioma) {
    default:
      $mensajeErrorConexion =
        "All songs are played from Deezer in streaming. You can't play offline";
      ...
      $("#InicioEstilos").html("Selection");
      $("#botonInicioCrear_").html("Challenge a friend");
      $("#gracias").html("Thanks to");

      // Página Niveles
      $("#mensajeCabeceraNiveles").html("Aork2 Levels");
      $(".textoNiveles").html("Level");

      // Página de Juego por estilos // Styles Page
      $("#mensajeCabeceraEstilos").html("Musical selection");
      $("#spanMensajeSeleccion1").html("Play with a selection of 10 songs from a same genre");
      $("#spanMensajeSeleccion2").html("This selection is weekly provided");
      $("#textoEstiloTop").html("HITS");
      $("#textoEstiloEspecial").html("Specials");
      $("#textoEstiloBSO").html("O.S.T.");

      // Página del Juego // Game Page
      $("#puntuacion").html("Score: ");
      $("#mensajeTituloCancion").html("Song title");
      $tituloCancion = "Song title";
      $autorCancion = "Guess the artist";
      ...
      $("#compartirCancionAcierto").html("Share this song");
      $("#salirCancionCompartir").html("Exit");

      // Página Fín del Juego // End of game Page
      //¡¡Has llegado al final del Juego!!
      $("#finMensaje1").html("You've reached the end of the Level !!");
      //Has acertado:
      $("#finMensaje2").html("You guessed it:");
      //Vamos añadiendo canciones, vuelve pronto.
      $("#finMensaje3").html("You've unlocked the next level");
      $("#botonFin").html("Continue");

      // Página Fín de juego en estilos //
      // ¡¡Has llegado al final del Juego por estílos en
      $("#estilosMensaje1").html(
        "You've reached the end of the game by style: "
      );
      // Has acertado:
      ...
      $("#estilosMensaje3").html(
        "The songs of each style changes weekly, so play again next week with new songs."
      );
      ...
      $("#retoMensaje").html(
        "Search, choose a song and challenge a friend to know if he knows it."
      );
      $("#retoGanasPuntos").html("You win 20 points!!");
      $("#retoMensaje2").html(
        "Your friend don't need the app to play, they can play in mobile browser."
      );
      ...
      $("#mensajeInfo1").html(
        "aork2 is the typical hangman game but in this case your goal is to guess the title of the proposed song"
      );
      ...
      $("#mensajeInfo2").html(
        "You can look for a song and challenge a friend by Twitter, Facebook, whatsapp or Google+ to see if he or she can guess it. If you want to try, you don't need to register or give personal dates, just push the button"
      );
      ...
      $("#mensajeNoMas1").html(
        "At this moment there are no more songs available in the individual game. We are adding songs, you can try again in a while and you will have more luck"
      );
      //Puedes buscar una canción y retar a un amigo a ver si la conoce a través de Twitter, Facebook, whatsapp o email. Si quieres probar, sin necesidad de registrarte, ni dar datos, solo pulsa el siguiente botón.
      $("#mensajeNoMas2").html(
        "You can look for a song and challenge a friend by Twitter, Facebook, whatsapp or Google+ to see if he or she can guess it. If you want to try, you don't need to register or give personal dates, just push the button"
      ...
      $("#mensajeNoMas3").html(
        "You can also try the individual game and try the different styles of music"
      );
      ...
      /*$("#datosInfo").html(
        "You have completed this level, you can play again all the songs, don't worry, you will not lose your points"
      );*/
      //Llevas acertadas:
      ...
      //Página de información cuando no hay más niveles
      $("#cabeceraNoMasNiveles").html("No more songs");
      //En estos momentos no hay más canciones disponibles en el modo de juego individual. Vamos añadiendo canciones, por lo que puedes volver a probar en un tiempo y seguro que tienes más suerte.
      $("#mensajeNoMasNiveles1").html(
        "At this moment there are no more songs available in the individual game. We are adding songs, you can try again in a while and you will have more luck"
      );
      //Puedes buscar una canción y retar a un amigo a ver si la conoce a través de Twitter, Facebook, whatsapp o email. Si quieres probar, sin necesidad de registrarte, ni dar datos, solo pulsa el siguiente botón.
      $("#mensajeNoMasNiveles2").html(
        "You can look for a song and challenge a friend by Twitter, Facebook, whatsapp or Google+ to see if he or she can guess it. If you want to try, you don't need to register or give personal dates, just push the button"
      );
      $("#botonNoMasNivelesRetar").html("Challenge");
      //También puedes jugar de modo invividual por estilos de música
      $("#mensajeNoNivelesMas3").html(
        "You can also try the individual game and try the different styles of music"
      );
      $("#botonNoMasNivelesEstilo").html("Styles Game");
      //O si lo prefieres, puedes volver a jugar todas las canciones desde el principio.<br />No te preocupes, no perderás tus puntos logrados.
      $("#datosInfoFinNivel").html(
        "You have completed this level, you can play again all the songs, don't worry, you will not lose your points"
      );
      //Llevas acertadas:
      $("#mensajeNoMas4").html("Guessed songs:");
      ...
      $("#MensajeBuscarArtista").html(
        "Play with the songs of a singer of your choice"
      );
      $("#labelBuscarArtista").html("Singer, group...");
      $("#botonBuscarArtista").html("Search");
      $("#botonLimpiarBuscarArtista").html("Clean");
      $("#retoBuscarArtista").html(
        "Get 35 points sharing the challenge with friends."
      );
      $("#retoBuscarArtista2").html(
        "Your friend don't need the app to play, they can play in mobile browser."
      );
      $("#retarArtistaText").html("Send challenge");
      // Página Aceptar Reto Artista

      $("#spanRetoArtista").html(
        "You have been challenged to play hangman with "
      );
      ...
      $compartirTitleTwitterArt =
        "#aork2 Do you accept this aork2 Artist Challenge? "; // A ver si conoces esta canción
      ...
      $(".textoCaptura").html(
        "Share this screen with friends and win 10 extra points"
      );
      $("#botonVolverCaptura").html("Back");

      // Página Licencia
      $("#textoLicencia").html(
        "You can get the source from GitHub. Touch the cat."
      );
      break;
  }
}
